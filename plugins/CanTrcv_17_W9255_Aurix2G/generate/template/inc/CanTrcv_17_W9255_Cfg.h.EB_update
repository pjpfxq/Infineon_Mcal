        ...
        [!IF "./CanTrcvWakeupByBusUsed = 'true'"!][!//
          [!IF "node:refexists(./CanTrcvIcuChannelRef/*[1]) ='true'"!][!//
            ...
            */
            ...
            [!CR!][!//
            [!IF "(node:ref(node:ref(./CanTrcvIcuChannelRef/*[1])/IcuWakeup/*[1]/IcuChannelWakeupInfo/*[1])/EcuMWakeupSourceId) != (node:ref(./CanTrcvWakeupSourceRef/*[1])/EcuMWakeupSourceId)"!]
              [!ERROR!][!//
