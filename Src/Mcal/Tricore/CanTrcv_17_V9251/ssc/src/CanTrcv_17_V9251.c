...
/* [cover parentID={F4373030-2F40-4d6e-A181-07DBFAF5C998}]
   [/cover] */
#include "CanIf.h"
/* CanIf_Cbk.h contains prototype of CAN Interface callback function */
#include "CanIf_Cbk.h"
...
#if ( CANTRCV_17_V9251_AR_RELEASE_MAJOR_VERSION != 4U )
...
/* [cover parentID={D16E1089-3609-460f-8F87-FDA0410D040D}]
     [/cover] */
#if ( CANTRCV_17_V9251_SW_MAJOR_VERSION != 10U )
#error "CANTRCV_17_V9251_SW_MAJOR_VERSION does not match. "
#endif

#if ( CANTRCV_17_V9251_SW_MINOR_VERSION != 40U )
...
void CanTrcv_17_V9251_Init(const CanTrcv_17_V9251_ConfigType* const ConfigPtr)
{
  ...
  uint8 TrcvIdx = CANTRCV_17_V9251_ZERO;
  ...
  if (ReturnValue == E_OK)
  {
    ...
    if (CurrentMode != OpMode)
    {
      ...
      if (OpMode == CANTRCV_TRCVMODE_NORMAL)
      {
        ...
        Cantrcv_17_V9251_WuReason[Transceiver]),0,31,CANTRCV_WU_INTERNALLY);
      ...
      Mcal_SetBitAtomic(&(CanTrcv_17_V9251_Channelstatus.
      Cantrcv_17_V9251_CurrentMode[Transceiver]),0,31,CANTRCV_TRCVMODE_NORMAL);
      ...
      Mcal_SetBitAtomic(&(CanTrcv_17_V9251_Channelstatus.
      Cantrcv_17_V9251_CurrentMode[Transceiver]),0,31,CANTRCV_TRCVMODE_STANDBY);
...
void CanTrcv_17_V9251_GetVersionInfo(Std_VersionInfoType* const versioninfo)
{
  ...
  if ((versioninfo) == NULL_PTR)
  {
    ...
    [/cover] */
    Det_ReportError((uint16)CANTRCV_17_V9251_MODULE_ID,
                    CANTRCV_17_V9251_INSTANCE_ID,
    ...
    if (TRUE == TrcvWubyBus)
    {
      ...
      if (TrcvWakeupMode == CANTRCV_WUMODE_ENABLE)
      {
        ...
        /* [cover parentID={1E096D68-EB72-4d4b-BAD4-D717FB2DC1A3}]
            [/cover] */
        Mcal_SetBitAtomic(&(CanTrcv_17_V9251_Channelstatus.
        CanTrcv_17_V9251_WakeupMode[Transceiver]),0,31,CANTRCV_WUMODE_ENABLE);
      ...
      else if (TrcvWakeupMode == CANTRCV_WUMODE_DISABLE)
      {
        ...
        Mcal_SetBitAtomic(&(CanTrcv_17_V9251_Channelstatus.
        CanTrcv_17_V9251_WakeupMode[Transceiver]),0,31,CANTRCV_WUMODE_DISABLE);
      }
...
Std_ReturnType CanTrcv_17_V9251_CheckWakeup(const uint8 Transceiver)
{
    ...
    /* End of (CANTRCV_17_V9251_DEV_ERROR_DETECT == STD_ON) */
  {
        ...
        (TRUE == TrcvWubyBus))
    {
      ...
      Mcal_SetBitAtomic(&(CanTrcv_17_V9251_Channelstatus.
      Cantrcv_17_V9251_WuReason[Transceiver]),0,31,CANTRCV_WU_BY_BUS);
...
static void CanTrcv_17_V9251_lSetInitMode(const uint8 Channel)
{
  ...
  /* [cover parentID={D4AE1E11-F60A-4095-BC1C-3A518D899821}]
     Put the CanTrcv into configured Mode [/cover] */
   Mcal_SetBitAtomic(&(CanTrcv_17_V9251_Channelstatus.
   Cantrcv_17_V9251_CurrentMode[TrcvChannelId]),0,31,TrcvNwMode);
  /* update Wake up reason as Wake up by Power On */
   Mcal_SetBitAtomic(&(CanTrcv_17_V9251_Channelstatus.
   Cantrcv_17_V9251_WuReason[TrcvChannelId]),0,31,CANTRCV_WU_POWER_ON);
   /* MISRA2012_RULE_2_2_JUSTIFICATION:Parameter TrcvChannelId is
   updated via assembly instruction, hence they are not unused.*/
...
static Std_ReturnType CanTrcv_17_V9251_lCheckUninitDet(const uint8 ServiceId)
{
  ...
  if (CanTrcv_17_V9251_DriverState == CANTRCV_17_V9251_UNINIT)
  {
    ...
    /* [cover parentID={85475AF2-750A-4fb0-ADF8-61CDF2BC7850}]
         [/cover] */
    Det_ReportError(CANTRCV_17_V9251_MODULE_ID, CANTRCV_17_V9251_INSTANCE_ID,
                    ServiceId, CANTRCV_17_V9251_E_UNINIT);
    /* return E_NOT_OK */
    RetVal = E_NOT_OK;
...
CanTrcv_17_V9251_lChannelIdDet(const uint8 Channel, const uint8 ServiceId)
{
  ...
  if (Channel >= CANTRCV_17_V9251_CHANNELS_CFG)
  {
    ...
    /* [cover parentID={6CE71A64-CFF0-4584-8109-B75A084ECB63}]
      [/cover] */
    Det_ReportError(CANTRCV_17_V9251_MODULE_ID, CANTRCV_17_V9251_INSTANCE_ID,
                    ServiceId, CANTRCV_17_V9251_E_INVALID_TRANSCEIVER);
  }
  else
  {
...
LOCAL_INLINE uint16 CanTrcv_17_V9251_lGetPendWu(const uint8 Channel)
{
  /* [cover parentID={FA309339-8152-4140-8B10-A44286709933}]
     Get the Pending Wake up of the CAN Transceiver channel [/cover] */
...
LOCAL_INLINE void CanTrcv_17_V9251_lSetPendWu(const uint8 Channel)
{
  ...
  /* [cover parentID={D437A20E-141C-4d73-B1A8-118CBDC612CE}]
     [/cover] */
