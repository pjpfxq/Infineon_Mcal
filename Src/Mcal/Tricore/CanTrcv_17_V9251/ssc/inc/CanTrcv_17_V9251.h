...
/* CAN Transceiver macros to set /clear */
#define CANTRCV_17_V9251_ZERO                             ((uint8)(0U))
#define CANTRCV_17_V9251_ONE                              ((uint8)(1U))
...
#define CanTrcv_17_V9251_GetVersionInfo(versioninfo)                          \
                       (ERROR_CanTrcv_17_V9251_GetVersionInfo_NOT_SELECTED)
