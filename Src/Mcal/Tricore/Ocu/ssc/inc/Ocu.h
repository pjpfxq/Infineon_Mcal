...
**  [/cover]                                                                  **
**                                                                            **
**  SPECIFICATION(S) : Ocu Driver Header file                                 **
**                                                                            **
...
#define Ocu_DeInit() (ERROR_Ocu_DeInit_NOT_SELECTED)
#endif
...
#define Ocu_EnableNotification(channel) \
                                     (ERROR_Ocu_EnableNotification_NOT_SELECTED)
#endif
...
#define Ocu_DisableNotification(channel) \
                                    (ERROR_Ocu_DisableNotification_NOT_SELECTED)
#endif
...
#define Ocu_SetPinAction(Channel,PinAction) \
                                           (ERROR_Ocu_SetPinAction_NOT_SELECTED)
#endif
...
#define Ocu_SetPinState(Channel,PinState) \
                                            (ERROR_Ocu_SetPinState_NOT_SELECTED)
#endif
/*******************************************************************************
**                                                                            **
...
/*MISRA2012_RULE_4_9_JUSTIFICATION:function like macro define used in preference
 *to function like macro where they are interchangeable*/
#define Ocu_GetCounter(Channel)              (ERROR_Ocu_GetCounter_NOT_SELECTED)
#endif
...
#define Ocu_SetAbsoluteThreshold(ChannelNumber,ReferenceValue,AbsoluteValue)\
                                   (ERROR_Ocu_SetAbsoluteThreshold_NOT_SELECTED)
#endif
...
#define Ocu_SetRelativeThreshold(ChannelNumber,RelativeValue)\
                                   (ERROR_Ocu_SetRelativeThreshold_NOT_SELECTED)
#endif
...
#define Ocu_GetVersionInfo(versioninfo)      \
                                       (ERROR_OcuGetVersionInfoApi_NOT_SELECTED)
#endif
...
#define Ocu_InitCheck(ConfigPtr) \
        (ERROR_Ocu_InitCheck_NOT_SELECTED)
#endif
