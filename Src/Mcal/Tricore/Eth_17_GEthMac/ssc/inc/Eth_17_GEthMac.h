...
#define ETH_17_GETHMAC_CR60_100MHZ          (0x00000000U)
#define ETH_17_GETHMAC_CR100_150MHZ         (0x00000100U)
#define ETH_17_GETHMAC_CR20_35MHZ           (0x00000200U)
#define ETH_17_GETHMAC_CR35_60MHZ           (0x00000300U)
#define ETH_17_GETHMAC_CR150_250MHZ         (0x00000400U)
#define ETH_17_GETHMAC_CR250_300MHZ         (0x00000500U)
...
#define ETH_17_GETHMAC_DMA_CH0_TXPBL              (0x08U)
...
*******************************************************************************/
extern uint32* const Eth_17_GEthMac_CoreInitStatus[ETH_17_GETHMAC_MAX_CORES];
/*******************************************************************************
...
#define Eth_17_GEthMac_UpdatePhysAddrFilter(CtrlIdx,PhysAddrPtr,Action) \
                                  (ERROR_EthUpdatePhysAddrFilter_NOT_SELECTED)
...
#define Eth_17_GEthMac_GetDropCount(CtrlIdx,CountValues,DropCount) \
                                    (ERROR_EthGetDropCountApi_NOT_SELECTED)
...
#define Eth_17_GEthMac_GetEtherStats(CtrlIdx,etherStats) \
                               (ERROR_EthGetEtherStatsApi_NOT_SELECTED)
...
#define Eth_17_GEthMac_GetCurrentTime(CtrlIdx,timeQualPtr,timeStampPtr) \
                               (ERROR_EthGlobalTimeSupport_NOT_SELECTED)
