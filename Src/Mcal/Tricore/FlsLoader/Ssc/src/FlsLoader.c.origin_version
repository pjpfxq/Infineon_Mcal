...
#if ( FLSLOADER_SW_MINOR_VERSION != 40U )
                            ...
                            const uint32 NumberOfBursts)
{
       ...
       Count++)
  {
    ...
    /* [cover parentID={A9233307-DCC7-4b12-B513-8FD75EA95C5F}][/cover] */
                           ...
                           const uint32 NoOfPages)
{
  ...
  for (Count = 0U; (Count < NoOfPages) && (RetError == FLSLOADER_E_OK); Count++)
  {
    ...
    /* [cover parentID={A6ED4E9D-4065-4e3d-8F34-B316647BED24}][/cover] */
    /*Check if Program Flash is in page mode */
    if (FlashType != FLSLOADER_DFLASH_BANK0)
    {
                                     ...
                                     const uint32 EraseTimeoutTicks)
{
  ...
  if (FlashType != FLSLOADER_DFLASH_BANK0)
  {
    ...
    /* [cover parentID={78B4481C-4FEB-4037-A806-1007EE7F019B}][/cover] */
  ...
  if (FlashType != FLSLOADER_DFLASH_BANK0)
  {
    ...
    /* [cover parentID={2BD231F8-1B0D-4884-A402-8E44979FA0ED}][/cover] */
                                   ...
                                   const uint32 PageTimeoutTicks)
{
  ...
  /* [cover parentID={CACA661F-6874-4f74-A439-AAC8B40CC35B}]
    Disable the end init protection
  [/cover] */
  if (FlashType != FLSLOADER_DFLASH_BANK0)
  {
    /* [cover parentID={D8101564-073E-4054-8CF8-3DAEBF28F87C}][/cover] */
    FlsLdr_ExclArea_PfProg_Enter();
    /* [cover parentID={7BA9F456-7C1A-450d-BB0F-8CD27CA67457}][/cover] */
    FlsLoader_lResetSafetyENDINIT();
  }
  ...
  /* [cover parentID={3C6AF263-D03B-43b2-8E63-F93AD24DA859}]
    Flash type is PFlash
  [/cover] */
  if ((FlashType != FLSLOADER_DFLASH_BANK0))
  {
    /* [cover parentID={46BAF2B4-5CF9-4aeb-97FC-609C1DB34B16}]
      Enable back the end init protection
    [/cover] */
    FlsLoader_lSetSafetyENDINIT();
    /* [cover parentID={040229FE-F17F-4560-A992-0EC07B34C89B}][/cover] */
                                   ...
                                   const uint32 BurstTimeoutTicks)
{
  ...
  /* [cover parentID={7005CA20-42C4-4a0d-995F-8B96EA82A070}]
     Flash type is PFlash
  [/cover] */
  if (FlashType != FLSLOADER_DFLASH_BANK0)
  {
    /* [cover parentID={E3719F16-BAD6-44f5-BC73-938451001B95}][/cover] */
    FlsLdr_ExclArea_PfProg_Enter();
    /* [cover parentID={95AB83E4-9352-4cf5-B060-8C8B5162AA31}][/cover] */
    FlsLoader_lResetSafetyENDINIT();
  }
  ...
  /* [cover parentID={F4C1F6EE-C6A4-4a96-8DA9-34866FF01A23}]
    Flash type is PFlash
  [/cover] */
  if ((FlashType != FLSLOADER_DFLASH_BANK0))
  {
    /* [cover parentID={D26A5F60-EE62-424b-9041-447737298E78}]
      Enable back the end init protection
    [/cover] */
    FlsLoader_lSetSafetyENDINIT();
    /* [cover parentID={1DBF49DC-D536-463c-9E92-199527756123}][/cover] */
    FlsLdr_ExclArea_PfProg_Exit();
  }
