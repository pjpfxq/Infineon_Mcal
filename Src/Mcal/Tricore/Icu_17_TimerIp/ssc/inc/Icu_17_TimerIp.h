...
#define Icu_17_TimerIp_EnableMultiEdgeDetection(Channel,EdgeCount)             \
                    (ERROR_Icu_17_TimerIp_EnableMultiEdgeDetection_NOT_SELECTED)
#endif
...
#define Icu_17_TimerIp_StartIncInterface(Channel) \
                         (ERROR_Icu_17_TimerIp_StartIncInterface_NOT_SELECTED)
#endif
...
#define Icu_17_TimerIp_StopIncInterface(Channel) \
                         (ERROR_Icu_17_TimerIp_StopIncInterface_NOT_SELECTED)
#endif
...
#define Icu_17_TimerIp_CalibratePos(Channel,Position) \
                                (ERROR_Icu_17_TimerIp_CalibratePos_NOT_SELECTED)
#endif
...
#define Icu_17_TimerIp_ReadEncCount(Channel) \
                                (ERROR_Icu_17_TimerIp_ReadEncCount_NOT_SELECTED)
#endif
...
#define Icu_17_TimerIp_ReadEncCountDir(Channel) \
                             (ERROR_Icu_17_TimerIp_ReadEncCountDir_NOT_SELECTED)
#endif
