...
#endif
#if ( DMA_SW_MINOR_VERSION != 40U )
  #error "DMA_SW_MINOR_VERSION does not match."
#endif
#if ( DMA_SW_PATCH_VERSION != 1U )
...
)
{
  ...
  if(*(Dma_CoreState[lCoreId]) != DMA_CPUCORE_INIT)
  {
    /* [cover parentID={6E95A468-4335-4d0f-B3DB-4F44DD2C953A}]
    Is DMA driver initialized?
    [/cover] */
    /* [cover parentID={2883942F-40F4-4d82-A75E-30B0BC017996}]
    Report DMA not initialized error
    [/cover] */
    /*Report DET on DriverState error*/
  ...
  [/cover] */
  else if( (MoveEngineNumber != DMA_ME_0) && (MoveEngineNumber != DMA_ME_1) &&
