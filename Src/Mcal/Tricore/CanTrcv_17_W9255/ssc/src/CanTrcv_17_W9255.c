...
/* Contains CanIf Callback functions */
#include "CanIf_Cbk.h"
...
#if ( CANTRCV_17_W9255_AR_RELEASE_MAJOR_VERSION != 4U )
...
/*[cover parentID={74F4CEEA-E43E-4fd0-960E-3CC41353DE5C}] Modules version
consistency check [/cover]*/
#if (CANTRCV_17_W9255_SW_MAJOR_VERSION != 10U)
#error "CANTRCV_17_W9255_SW_MAJOR_VERSION does not match. "
#endif

#if (CANTRCV_17_W9255_SW_MINOR_VERSION != 40U)
...
#define CANTRCV_17_W9255_ZERO_U                          (0U)
#define CANTRCV_17_W9255_ONE_U                           (1U)
...
static Std_ReturnType CanTrcv_17_W9255_lSpiRetries(const Spi_SequenceType SpiSequenceId,
...
static Std_ReturnType CanTrcv_17_W9255_lWuReasonChecks(const uint8 ChannelIndex,
    const CanTrcv_TrcvModeType Mode, const uint8 serviceId, const CanTrcv_TrcvModeType OpMode);
#if (CANTRCV_17_W9255_GENERAL_WAKE_UP_SUPPORT ==    \
...
#endif
static Std_ReturnType CanTrcv_17_W9255_lSpiBusyCheck(uint8 ChannelId);
  ...
  #endif
  {
                ...
                (ReturnValue == E_OK)); ChannelIndex++)
    {
      ...
      if(ReturnValue == E_OK)
      {
        ...
        Mcal_SetBitAtomic(&(CanTrcv_17_W9255_WuReason[ChannelId]), 0, 31,
                          CANTRCV_WU_RESET);
        ...
        if(ReturnValue == E_OK)
        {
          ...
          if (CanTrcvWuByBus == STD_ON)
          {
            ...
            ReturnValue = CanTrcv_17_W9255_lCheckInitWakeup(ChannelIndex, ChannelId);
          }
...
)
{
  ...
  if ((versioninfo) == NULL_PTR)
  {
    ...
    Det_ReportError((uint16)CANTRCV_17_W9255_MODULE_ID,
                    CANTRCV_17_W9255_INSTANCE_ID,
...
)
{
  ...
  if (DevError == E_OK)
  {
        ...
        (TrcvWakeupMode != CANTRCV_WUMODE_CLEAR))
    {
      ...
      Det_ReportError( CANTRCV_17_W9255_MODULE_ID,
                       CANTRCV_17_W9255_INSTANCE_ID,
                       CANTRCV_17_W9255_SID_SETWAKEUPMODE,
  ...
  #endif
  {
    ...
    if (TrcvWakeupMode == CANTRCV_WUMODE_ENABLE)
    {
      ...
      Mcal_SetBitAtomic(&(CanTrcv_17_W9255_WakeupMode[Transceiver]), 0, 31,
        ...
        if (Mode !=  CANTRCV_TRCVMODE_NORMAL)
        {
              ...
              (CanTrcvWuByBus == STD_ON))
          {
            ...
            if (ReturnValue == E_OK)
            {
              ...
              Set the CAN transceiver hardware to Normal mode and update the return status
              [/cover] */
              ReturnValue = CanTrcv_17_W9255_lSpiRetries(SpiSequenceUsed,
                            &CanTrcv_17_W9255_DestBuffer[Transceiver],
                            CANTRCV_17_W9255_SID_CHECKWAKEUP,
...
void CanTrcv_17_W9255_MainFunction(void)
{
  ...
  /* [cover parentID={6739BD40-654E-4e42-8CE8-00B9189D220D}]
  Return
  [/cover] */
  return;
    ...
    if(ReturnValue == E_OK)
    {
      ...
      if (ReturnValue == E_OK)
      {
        ...
        TimeoutStatus = (CanTrcv_17_W9255_DestBuffer[Transceiver] >>
              CANTRCV_17_W9255_SHIFT_BY_TWO) & (uint16)CANTRCV_17_W9255_ONE_U;

        /* [cover parentID={3497AF84-A9C6-4909-8915-D63F940EE278}]
        Is CANTO bit set?
        [/cover] */
        /* Check if the flag is set */
        if(TimeoutStatus == CANTRCV_17_W9255_ONE_U)
        {
    ...
    if(ReturnValue == E_OK)
    {
      ...
      if (ReturnValue == E_OK)
      {
        ...
        SilenceFlag = (CanTrcv_17_W9255_DestBuffer[Transceiver] >>
                 CANTRCV_17_W9255_ONE_U) & (uint16) CANTRCV_17_W9255_ONE_U;

        /* [cover parentID={2995F79A-F70A-4def-99E1-6E2F7A3E27E7}]
        Is CANSIL bit set?
        [/cover] */
        /* Check if Silence flag is set */
        if(SilenceFlag == CANTRCV_17_W9255_ONE_U)
        {
          /* [cover parentID={37AAC141-6186-44de-95A6-FB8267695219}]
          Update flag state
          [/cover] */
    ...
    if (ReturnValue == E_OK)
    {
           ...
           CANTRCV_17_W9255_SYSERR_CHECK))
      {
             ...
             == CANTRCV_17_W9255_WUF_CHECK))
        {
          ...
          Mcal_SetBitAtomic(&(CanTrcv_17_W9255_WuReason[Transceiver]), 0, 31,
                            CANTRCV_WU_BY_BUS);
        }
...
static Std_ReturnType CanTrcv_17_W9255_lCheckUninitDet(const uint8 serviceId)
{
  ...
  if (CanTrcv_17_W9255_InitState == CANTRCV_17_W9255_UNINIT)
  {
    ...
    Det_ReportError(CANTRCV_17_W9255_MODULE_ID, CANTRCV_17_W9255_INSTANCE_ID,
  ...
  const uint16* const Buffer, const uint8 serviceId, const uint8 DetRaise)
{
  ...
  /* [cover parentID={A9379B6C-7137-4ddf-AA65-E0D8AC53AC14}]
  DET is ON
  [/cover] */
  #if (CANTRCV_17_W9255_DEV_ERROR_DETECT == STD_ON)
  /* [cover parentID={5035DCEF-BDBF-40f2-A12B-77D5355D6CF1}]
  Check for SPI error
  [/cover] */
  if(RetStatus == E_OK)
  {
    ...
    if (ErrorFlag == CANTRCV_17_W9255_SPI_ERROR_CHECK)
    {
      ...
      if(DetRaise == CANTRCV_17_W9255_REPORT_DET)
      {
        ...
        [/cover] */
        /* There is no/incorrect communication. Report error to DET */
        Det_ReportError(    CANTRCV_17_W9255_MODULE_ID,
                            CANTRCV_17_W9255_INSTANCE_ID,
                            serviceId,
                            CANTRCV_17_W9255_E_NO_TRCV_CONTROL
                       );
      }
      RetStatus = E_NOT_OK;
    }
...
(const uint8 ChannelIndex, const uint8 Transceiver)
{
  ...
  Mcal_SetBitAtomic(&(CanTrcv_17_W9255_WakeupMode[Transceiver]), 0,
                    31, CANTRCV_WUMODE_ENABLE);
  ...
  if (ReturnValue == E_OK)
  {
         ...
         == CANTRCV_17_W9255_WUF_CHECK))
    {
      ...
      {
        /* Set the Wake up reason to Wake up by pin */
        Mcal_SetBitAtomic(&(CanTrcv_17_W9255_WuReason[Transceiver]), 0,
                          31, CANTRCV_WU_BY_PIN);
      }
      else
      {
        /* Set the Wake up reason to Wake up by bus */
        Mcal_SetBitAtomic(&(CanTrcv_17_W9255_WuReason[Transceiver]), 0,
                          31, CANTRCV_WU_BY_BUS);
      }
    ...
    const uint8 serviceId, const CanTrcv_TrcvModeType OpMode)
{
  ...
  if(PnIndex != CANTRCV_17_W9255_PN_NOT_CONFIGURED)
  {
          ...
          CANTRCV_17_W9255_SYSERR_CHECK)))
    {
      ...
      if((ReturnValue == E_OK) &&
          ((DestBuf & CANTRCV_17_W9255_SYSERR_CHECK) ==
           CANTRCV_17_W9255_ZERO_U) && (OpMode == CANTRCV_TRCVMODE_NORMAL))
      {
  ...
  if(PnIndex != CANTRCV_17_W9255_PN_NOT_CONFIGURED)
  {
          ...
          CANTRCV_17_W9255_SYSERR_CHECK)))
    {
      ...
      if(((DestBuf & CANTRCV_17_W9255_POR_CHECK) ==
          CANTRCV_17_W9255_POR_CHECK))
      {
        Mcal_SetBitAtomic(&(CanTrcv_17_W9255_WuReason[ChannelId]), 0,
                          31, CANTRCV_WU_POWER_ON);
      }
      else
      {
