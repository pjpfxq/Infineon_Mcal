        ...
        const Adc_GroupType GroupId, const uint8 ServiceId, const uint32 CoreId)
{
          ...
          NULL_PTR)
  {
    ...
    Number of Cores available are greater than one and MultiCore Error Detection
    is on or Safety is on [/cover] */
    #if (MCAL_NO_OF_CORES > ADC_ONE_U)
    #if ((ADC_MULTICORE_ERROR_DETECT == STD_ON)||(ADC_SAFETY_ENABLE == STD_ON))
        ...
        const Adc_GroupType GroupId, const uint8 ServiceId, const uint32 CoreId)
{
  ...
  /* [cover parentID={079E160B-4AD8-4467-948C-F0A291892604}] Check if Service ID
     is equal to START or STOP Group Software conversion [/cover] */
