...
#define Dsadc_InitCheck(ConfigPtr)        (ERROR_Dsadc_InitCheck_NOT_AVAILABLE)
#endif
...
/*MISRA2012_RULE_4_9_JUSTIFICATION:Function like macro is used to generate
  compilation error, when an optional function is called by application
  and not enabled in the configuration*/
#define Dsadc_DeInit()             (ERROR_Dsadc_DeInit_NOT_AVAILABLE)
#endif
...
#define Dsadc_ReadStreamResults(ChannelId, ResultLinearBufferPtr) \
	                          (ERROR_Dsadc_ReadStreamResults_NOT_AVAILABLE)
#endif
...
#define Dsadc_ReadResult(ChannelId, ResultPtr) \
	                          (ERROR_Dsadc_ReadResult_NOT_AVAILABLE)
#endif
...
#define Dsadc_SetupResultBuffer(ChannelId, DataBufferPtr, Size) \
                          (ERROR_Dsadc_SetupResultBuffer_NOT_AVAILABLE)
#endif
...
#define Dsadc_GetVersionInfo(versioninfo) \
                            (ERROR_Dsadc_GetVersionInfo_NOT_AVAILABLE)
#endif
...
/*MISRA2012_RULE_4_9_JUSTIFICATION:Function like macro is used to generate
  ...
  is disabled */
#define Dsadc_Isr(HwChannelId) (ERROR_Dsadc_Isr_NOT_AVAILABLE)
#endif
