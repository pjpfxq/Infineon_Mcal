...
typedef volatile struct _Ifx_INT
{
       ...
       Ifx_INT_ACCEN_SRC                   ACCEN_SRC[2];           /**< \brief 180, Access Enable covering all SRCx[31:16] mapped to ICU${x}, Register 1*/
       Ifx_UReg_8Bit                       reserved_190[112];      /**< \brief 190, \internal Reserved */
       Ifx_INT_CH                          CH[2];                  /**< \brief 200, */
       Ifx_UReg_8Bit                       reserved_220[3552];     /**< \brief 220, \internal Reserved */
} Ifx_INT;
